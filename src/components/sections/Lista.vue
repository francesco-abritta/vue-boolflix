<template>
  <div>
    ...
    <div  v-if="film.length>0" class="topFilm" id="film">
        <h1>Film</h1>
        <div class="scrollSerie"><a href="#serie">Vai alle Serie Tv <i class="fas fa-arrow-down"></i></a></div>
    </div>
    <div class="listaFilm">
    ...
    <div v-if="series.length>0" class="topSeries" id="serie">
        <h1>Serie Tv</h1>
        <div class="scrollFilm"><a href="#film">Vai ai Film <i class="fas fa-arrow-up"></i></a></div>
    </div>
